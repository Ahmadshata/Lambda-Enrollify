...
def lambda_handler(event, context):
    ...
    authResponse = { "principalId": "1", "policyDocument": { "Version": "2012-10-17", "Statement": [{"Action": "execute-api:Invoke", "Resource": ["arn:aws:execute-api:eu-west-2:253823388836:56jm3tsif4/*/*"], "Effect": auth}] }}
    return authResponse